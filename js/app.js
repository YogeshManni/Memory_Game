...
var inner_boxes_array=['&#9924','&#9924','&#9749','&#9749','&#9970','&#9970','&#9875','&#9875','&#9889','&#9889','&#9918','&#9918','&#9973','&#9973',' &#9748',' &#9748'];		
...
{	
	...
	innerBox.addEventListener("click",function(event)
		{	if(Boxes_flipped==2)
			...
			Boxes_flipped++;
			changeInnerBox(innerBox,index,check_array,Boxes_flipped);
		});
}

function changeInnerBox(innerBox,index,check_array,Boxes_flipped)
{	
	check_array[global_index]=inner_boxes_array[index];
	...
	global_index++;
	innerBox.style.background="orange";
	...
	if(check_array[global_index]==check_array[global_index-1])	//if both matches then they stay as it is
	{
	total_tiles+=2;	// Keeping track of number of tiles which are flipped.
	...
	{	move++;
		...
		document.getElementById(id).style.pointerEvents='auto'; /* enabling click on both
																 * the divs
																 */
		...
		function flipBack()
		{
		innerBox.style.background="red";	//flipping down current box
		innerBox.innerHTML="";
		innerBox.style.transition="0.5s";

		var previous_Box=document.getElementById(id);//flipping down previous box;
		previous_Box.style.background="red";
...
{	
	...
	document.getElementById("Stars2").innerHTML=star_count;
